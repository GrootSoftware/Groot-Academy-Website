...
<div class="course_detail">
    <div class="cr_detail_sec">
        ...
        <h4 style="font-size: 21px;">Open the Doors of Opportunity by Becoming an Expert Full Stack Developer</h4>
        ...
        <p style="text-align: justify;">Full-stack development is about understanding the two areas in sufficient detail and making communication between them easy and smooth. As technologies and industries evolve, Full-Stack developers need to learn new technologies to stay abreast of the latest trends and this is where Groot Academy is going to partner you in the journey. This broad range of skills across the stack is a superpower for software developers.
            ...
            If you’re a fresher looking to break into your tech career or a mid-career professional looking to enter the world of web development from a non-tech profession, you should consider the following advantages of becoming a full-stack developer:
...
<div class="rs-services style4 modify1 gray-color pt-40 pb-120 md-pt-75 md-pb-40 sm-pb-70">
    <div class="px-4 d-flex justify-content-around">
        <h4 class="mt-4">Java Full Stack Developer</h4>
    </div>
    <div class="px-4 d-flex justify-content-around">
        ...
        <div class="contentAcc">
            ...
            <div class="sergio">
                ...
                <h2>Introduction to WEB <span class="down_arrow">&#8682;</span> </h2>

                <ul>
                    <li>What is Web?</li>
                    <li>Web Features?</li>
                    <li>W3C and W3C Members</li>
                    <li>Introduction to What WG</li>
                </ul>

                <h2>Core HTML<span class="down_arrow">&#8682;</span> </h2>

                <ul>
                    <li>Introduction</li>
                    <li>Parts in HTML Document</li>
                    ...
                    <li>Body Section</li>
                    <li>HTML FORMS</li>
                    <li>Anchors, Images</li>
                </ul>

                <h2>Advance HTML5<span class="down_arrow">&#8682;</span> </h2>
                ...
                <ul>
                    ...
                    <li>Structure of HTML5 Document</li>
                    <li>Power of HTML5 and Features</li>
                    <li>Semantics and Block Level Elements</li>
                    <li>HTML5 Forms</li>
                ...
                <h2>Core CSS<span class="down_arrow">&#8682;</span> </h2>
                ...
                <h2>Advance CSS <span class="down_arrow">&#8682;</span> </h2>
                ...
                <h2>UNIONEVENT HANDLING REACT<span class="down_arrow">&#8682;</span> </h2>
                ...
                <ul>
                    ...
                    <li>U SP of Java: Java Features</li>
        ...
        <div class="contentAcc">
            <div class="sergio">
                ...
                <ul>
                    ...
                    <li>Getting and setting values of an object's field if field name is unknown until runtime</li>
                ...
                <ul>
                    ...
                    <li>Servlet with Annotations</li>
                    <li>@WebServlet</li>
                    <li>@WebInitParam</li>
                    <li>@WebListener</li>
                    <li>@WebFilter</li>
                    ...
                    <li>Session Tracking&amp;State Management</li>
                    <li>Cookie</li>
                    <li>Url Rewriting</li>
                ...
                <h2>HIBERNATE<span class="down_arrow">&#8682;</span> </h2>
                ...
                <ul>
                    ...
                    <li>A “Hello world” stand-alone application</li>
                    <li>A Servlet–Based Hibernate application</li>
                </ul>
                ...
                <h2>MAPPING INHERITANCE WITH JAVA CLASSES<span class="down_arrow">&#8682;</span> </h2>
                <ul>
                    <li>Table-Per –class Hierarchy Mapping</li>
                    <li>Table-Per –subclass Hierarchy Mapping</li>
                    <li>Table-Per –concrete-subclass Hierarchy Mapping</li>
